...
import TimelinePage from './pages/eras/TimelinePage';
...
import EventDetailPage from './pages/eras/EventDetailPage';
import FigureDetailPage from './pages/figures/FigureDetailPage';
import DocumentDetailPage from './pages/documents/DocumentDetailPage';
import QuotesPage from './pages/figures/QuotesPage';
import QuoteDetailPage from './pages/figures/QuoteDetailPage';
